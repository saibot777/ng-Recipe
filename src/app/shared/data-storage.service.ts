...
export class DataStorageService {
  ...
  storeRecipes() {
    ...
    //   // headers: headers
    // });
    const req = new HttpRequest('PUT', 'https://recipebook-1e31e.firebaseio.com/recipes.json', 
  ...
  getRecipes() {
    ...
    this.httpClient.get<Recipe[]>('https://recipebook-1e31e.firebaseio.com/recipes.json', {
      observe: 'body',
      responseType: 'json'
    })
      .map(
